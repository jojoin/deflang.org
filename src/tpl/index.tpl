...
<!--导航栏高亮-->
<script type="text/javascript">nav_active="nav_l1"</script>

<!--左侧内容-->
<div id="left">
	<h3>简介</h3>
	<p>Def 是新一代基于虚拟机的脚本编程语言，拥有 C 的简捷语法和 Lisp 的强大表现力。</p>
	<p>Def 支持多范式、反射、元编程、函数式、垃圾回收等高级特征。通过强大的独一无二的处理器语法，让 Def 成为"可编程的编程语言"，甚至在运行时期改变程序行为。运用其精简直观的语法，可快速构建出模块化、易重构、可读性强的应用程序。</p>
