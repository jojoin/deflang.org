...
<div>import</div> <u>"fs"</u>  <span># 加载文件系统模块（系统自带）</span>
<div>import</div> <u>"mymod.d"</u>  <span># 加载自定义模块</span>
<div>import</div> <u>"dir/mymod.d"</u>  <span># 加载其它目录下的模块</span>
<div>import</div> <u>"../mymod.d"</u>  <span># 加载上级目录模块</span>
</code>
...
<span># 为加载的模块取别名</span>
mod : <div>import</div> <u>"mymod.d"</u>
