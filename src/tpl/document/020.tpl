...
<table>
	...
	<tr><td>nil</td><td>空变量字面值</td><td>val : none</td></tr>
	...
	<tr><td>fn</td><td>定义函数</td><td>fn func(a b)<br/>　a + b<br/>;</td></tr>
	<tr><td>class</td><td>定义类</td><td>保留</td></tr>

	<tr><td>ret</td><td>函数或处理器返回值</td><td>def func(a b)<br/>　if a>b<br/>　　ret a<br/>　;<br/>　b<br/>;</td></tr>
	<tr><td>ctn</td><td>while 循环继续</td><td>while n>0<br/>　if a>b<br/>　　ctn<br/>　;<br/>　b<br/>;</td></tr>
	<tr><td>brk</td><td>while 循环跳出</td><td>def func(a b)<br/>　if n=5<br/>　　brk<br/>　;<br/>　b : b + 1<br/>;</td></tr>

	<tr><td>try , catch, throw</td><td>异常处理</td><td><a href="/document/100.html">查看示例</a></td></tr>
